...
namespace JewelryStore.Infra
{
	public class Common
	{
		...
		public static long Get_Session_Int(string key) => (AppHttpContextAccessor.AppHttpContext != null && AppHttpContextAccessor.AppHttpContext.Session.Keys.Any(x => x == key) ? Convert.ToInt64(AppHttpContextAccessor.AppHttpContext.Session.GetString(key) ?? "0") : 0);
		...
		public static string Logo_Base64 => AppHttpContextAccessor.AppConfiguration.GetSection("IdentityCardPrint_Configuration:Logo_Base64").Value;
		public static string App_Title => AppHttpContextAccessor.AppConfiguration.GetSection("IdentityCardPrint_Configuration:App_Title").Value;
		public static string Address_Line1 => AppHttpContextAccessor.AppConfiguration.GetSection("IdentityCardPrint_Configuration:Address_Line1").Value;
		public static string Address_Line2 => AppHttpContextAccessor.AppConfiguration.GetSection("IdentityCardPrint_Configuration:Address_Line2").Value;
		public static float PageSize_Width => float.TryParse(AppHttpContextAccessor.AppConfiguration.GetSection("IdentityCardPrint_Configuration:PageSize_Width").Value, out var x) ? x : 2.125f;
		public static float PageSize_Height => float.TryParse(AppHttpContextAccessor.AppConfiguration.GetSection("IdentityCardPrint_Configuration:PageSize_Height").Value, out var x) ? x : 3.375f;
		...
		public static bool IsUserLogged() => Get_Session_Int(SessionKey.KEY_USER_ID) > 0 || Get_Session_Int(SessionKey.KEY_USER_ID) == -1 || (Get_Session_Int(SessionKey.KEY_USER_ID) == 0 && IsAdmin());
		public static bool SetUserLogged() => GetUserId() > 0;
		public static bool IsSuperAdmin() => Get_Session_Int(SessionKey.KEY_USER_ROLE_ID) == 1;
		public static bool SetSuperAdmin() => GetRoleId() == 0;
		public static bool IsAdmin() => Get_Session_Int(SessionKey.KEY_IS_ADMIN) == 1 || Get_Session_Int(SessionKey.KEY_IS_SUPER_USER) == 1;
		public static bool SetAdmin() => GetIsAdmin() == 1;
		public static Int64 LoggedUser_Id() => Get_Session_Int(SessionKey.KEY_USER_ID);
		public static Int64 LoggedCompany_Id() => Get_Session_Int(SessionKey.KEY_COMPANY_ID);
		public static Int64 LoggedUser_RoleId() => Get_Session_Int(SessionKey.KEY_USER_ROLE_ID);
		public static long _user_Id { get; set; }
		public static long _companyId { get; set; }
		public static long _roleId { get; set; }
		public static int _IsAdmin { get; set; }
		...
		public static void SetUserId(Int64 value) => _user_Id = value;
		public static Int64 GetUserId() => _user_Id;

		public static void SetCompanyId(Int64 value) => _companyId = value;
		public static Int64 GetCompanyId() => _companyId;


		public static void SetRoleId(Int64 value) => _roleId = value;
		public static Int64 GetRoleId() => _roleId;

		public static void SetIsAdmin(Int32 value) => _IsAdmin = value;
		public static Int32 GetIsAdmin() => _IsAdmin;

		public static void SetUserName(String value) => _UserName = value;
		public static String GetUserName() => _UserName;

		public static void SetUserRole(String value) => _UserRole = value;
		public static String GetUserRole() => _UserRole;
		...
		public static void Configure_UserMenuAccess(List<UserMenuAccess> userMenuAccess) => UserMenuAccess = userMenuAccess;
