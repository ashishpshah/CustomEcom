namespace JewelryStore.Infra
{
	public static class SessionKey
	{
		...
		public static string KEY_COMPANY_ID => "AuthenticatedCompanyID";
		public static string KEY_IS_SUPER_USER => "AuthenticatedSuperUser";
		public static string KEY_IS_ADMIN => "AuthenticatedAdminUser";
		public static string KEY_IS_FIELD_OFFICER => "AuthenticatedFieldOfficer";
        ...
        public static string KEY_USER_MENUPERMISSION => "AuthenticatedUserMenuPermission";
