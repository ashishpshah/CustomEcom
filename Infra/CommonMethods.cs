...
namespace JewelryStore.Infra
{
	...
	public class SelectListItem_Custom
	{
		...
		public SelectListItem_Custom(string value, string text, string group, int orderBy = 0)
		{
			Value = value;
			Text = text;
			Group = group;
		...
		public SelectListItem_Custom(string value, string text, string otherData, string group, int orderBy = 0)
		{
			Value = value;
			Text = text;
			Value2 = otherData;
		...
		public SelectListItem_Custom(string value, string text, string otherData, string extraData, string group, int orderBy = 0)
		{
			Value = value;
			Text = text;
			Value2 = otherData;
